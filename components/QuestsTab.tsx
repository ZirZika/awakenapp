...
const QuestsTab: React.FC<QuestsTabProps> = ({
  ...
  return (
    ...
    >
      <View style={[
        styles.questsContainer,
        isDesktop && styles.questsContainerDesktop,
        isTablet && styles.questsContainerTablet
      ]}>
        {/* Quest Board Section - Now first */}
        <View style={[
          styles.questSection,
          isDesktop && styles.questBoardWidgetDesktop
        ]}>
          <SectionHeader
          ...
          <WidgetCard>
            <Text style={styles.sectionDescription}>
              {t('Special quests created by admins. Accept challenging quests to earn bonus rewards and test your skills!')}
            </Text>
            {aiQuests.length > 0 ? (
              ...
              <EmptyState
                ...
                title={t('No Quest Board Quests Available')}
                description={
                  t('Check back regularly for new admin-created quests with special rewards!')
                }
              >
                <GlowingButton
        ...
        <View style={[
          styles.questSection,
          isDesktop && styles.systemQuestsWidgetDesktop
        ]}>
          <SectionHeader
        ...
        <View style={[
          styles.questSection,
          isDesktop && styles.storyQuestsWidgetDesktop
        ]}>
          <SectionHeader
        ...
        {completedQuests.length > 0 && (
          <View style={[
            styles.questSection,
            isDesktop && styles.completedQuestsWidgetDesktop
          ]}>
            <SectionHeader
